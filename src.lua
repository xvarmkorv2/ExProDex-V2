...
ContentProv:Preload("rbxassetid://59784769")
ContentProv:Preload("rbxassetid://4492476121")
ContentProv:Preload("rbxassetid://4460063940")
ContentProv:Preload("rbxassetid://5832745500")
ContentProv:Preload("rbxassetid://7360649366")
...
"rbxassetid://2998647800",
"rbxassetid://59784769",
"rbxassetid://4492476121",
"rbxassetid://4460063940",
"rbxassetid://5832745500",
"rbxassetid://7360649366",
"rbxassetid://483448923",
"rbxassetid://418720155",
"rbxassetid://969742484"
}
...
Creator.Text = "DEX V2 by: Moon || ExProDex by: nul"
...
createSetting("SaveInstance decompiles scripts","SaveInstanceScripts",false)
...
createMapSetting(SaveMapSettingFrame.Scripts,"SaveScripts",false)
createMapSetting(SaveMapSettingFrame.Terrain,"SaveTerrain",false)
createMapSetting(SaveMapSettingFrame.Lighting,"LightingProperties",false)
createMapSetting(SaveMapSettingFrame.CameraInstances,"CameraInstances",false)
...
SaveMapButton.MouseButton1Click:connect(function()
	...
	local consoleFunc = consoleprint
...
local function ToValue(value,type)
	...
	elseif type == "Script" then
		...
		loadstring(
			"getgenv().D_E_X_DONOTUSETHISPLEASE = "..value
		)()
...
function PromptSaveInstance(inst)
	if not SaveInstance and not getgenv().SaveInstance then CreateCaution("SaveInstance Missing","You do not have the SaveInstance function installed. Please go to RaspberryPi's thread to retrieve it.") return end
